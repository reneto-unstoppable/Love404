...
export function SwipeCard({ profile, onSwipeLeft, onSwipeRight }: SwipeCardProps) {
  return (
    <div className="relative w-full max-w-sm mx-auto flex flex-col items-center gap-4">
      <Card className="w-full h-[550px] rounded-2xl overflow-hidden shadow-2xl bg-card border-4 border-card-foreground/20 flex flex-col transition-all duration-300 hover:transform hover:scale-105 hover:-rotate-2">
